<body class="grey darken-4">
  ...
  <div class="container" style="min-height: 100vh; padding-top: 3rem; padding-bottom: 3rem;">
    <div class="card grey darken-4 z-depth-3">
      <!-- Header -->
      <div class="page-header" style="background-color: #0284c7; padding: 32px 24px; border-radius: 12px 12px 0 0;">
      ...
      <div class="card-content grey-text text-lighten-4">
        <div class="row">
          ...
          <div class="col s12 m6">
            ...
            <h4 class="blue-text text-lighten-2" style="font-weight: 600;">
          ...
          <div class="col s12 m6 center-align valign-wrapper" style="height: 100%;">
            ...
            ?>
            <?php if ($fileExists): ?>
              <img src="<?php echo $imagePath; ?>" alt="Ảnh sản phẩm" class="product-image responsive-img" />
            <?php else: ?>
              <p class="grey-text text-lighten-1">Không có ảnh hoặc file không tồn tại </p>
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 3rem;">
          <div class="col s12 m6 center-align">
            <a href="/webbanhang/Product/index" class="btn btn-custom waves-effect waves-light">
              <i class="material-icons left">arrow_back</i> Quay lại trang chủ
            </a>
          </div>
          <div class="col s12 m6 center-align">
            <a href="/webbanhang/Product/index" class="btn btn-custom waves-effect waves-light">
              <i class="material-icons left">list</i> Quay lại danh sách sản phẩm
            </a>
          </div>
        </div>
      </div>
